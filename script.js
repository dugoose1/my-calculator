...
// ===== HEART EYES ON EQUALS =====
const eyesOverlay = document.querySelector('.eyes-overlay');

document.querySelector('[data-action="equals"]').addEventListener('click', () => {
  eyesOverlay.classList.add('heart-eyes');
});

// Go back to normal when any OTHER button is clicked
document.querySelectorAll('.btn:not([data-action="equals"])').forEach(btn => {
  btn.addEventListener('click', () => {
    eyesOverlay.classList.remove('heart-eyes');
  });
});
